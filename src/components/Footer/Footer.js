...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark text-center pt-4 text-white">
      <div className="container">
        <div className="footer-body pt-2">
          <div className="footer-content" style={{ zIndex: '5' }}>
            <div className="mb-0 p-4">
              <a href="https://github.com/wittywatz" style={linkStyle}>
              ...
              <a href="https://www.instagram.com/wittywatz" style={linkStyle}>
                <i className="fab ml-4 fa-instagram icon-footer"></i>
              </a>
              <a style={linkStyle} href="mailto:watsonagbramu@gmail.com">
